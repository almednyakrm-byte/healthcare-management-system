        ...
        <table class="table">
            ...
            <tbody id="records">
                ...
                foreach ($records as $record) {
                    ...
                    echo '<td>';
                    echo '<a href="edit_مرضى.php?id=' . $record['id'] . '">تعديل</a> | ';
                ...
                .then(data => {
                    ...
                    data.forEach(record => {
                        ...
                        row.innerHTML = `
                            ...
                            <td>${record.age}</td>
                            <td>
                                <a href="edit_مرضى.php?id=${record.id}">تعديل</a> | 
...
$records = array(
    array('id' => 1, 'name' => 'محمد', 'birthdate' => '1990-01-01', 'age' => 32),
    array('id' => 2, 'name' => 'أحمد', 'birthdate' => '1995-01-01', 'age' => 27),
    array('id' => 3, 'name' => 'عبد الله', 'birthdate' => '1980-01-01', 'age' => 42)
);
...
Note: This code assumes you have a backend script (`backend/مرضى.php`) that fetches records from a database and returns them as JSON. You should replace the hardcoded records with your actual database query.